...
to say magicdrakedesc:
	...
	if mdasslevel is 0:
		...
		say "     You've ended up crossing paths with that dragon sorceress again. Her ultra-wide hips sway as the green-scaled shemale strides towards you. Her sheer blue dress hides nothing of her imposing figure - ten foot tall body, beachball breasts, titanic cock, basketball sized testicles and of course her two meter wide ass. The sight of you has clearly gotten her excited as well, her nipples hard and her cock perking up quickly.";
...
to say losetomagicdrake:
		...
		if Player consents:
			...
			if the remainder after dividing mdrakeloss by 3 is 1:
				...
				if Player is male and Cock Length of Player < Cock Length entry and "Female Preferred" is not listed in feats of Player and "Modest Organs" is not listed in feats of Player:
					...
					say "     While cumming, the draconic sorceress reaches around to [if Nipple Count of Player is 0 or Breast Size of Player is 0]your flat chest and rubs it[else]your bouncing tits and kneads them[end if]. Chanting softly, words obscured by the gurgling blasts of all the cum filling you, she sends magical power through her hands that causes your breasts to grow further. When she's done both her climax and her spell, she [if scalevalue of Player < 3]peels[else]eases[end if] you off her softening penis and leaves you there, bloated with her semen and leaking a steady flow of it from your gaping back door.";
	...
	to say mdrake_bigger_better:
		...
		if mdmaxlossscene is 0:
			...
			WaitLineBreak; [Maybe the drake casting a spell, picking up all the koballoons, merging them into a dildo shape and feeding it into the pcs rear to make it grow?]
...
[		if Player is female:
		...
		if Player is female and ( Cunt Depth of Player > 30 or Cunt Tightness of Player > 18 ):
			choose a blank row in table of fucking options;
...
[			if Player is female:
				...
				if Cunt Depth of Player > 1 or Cunt Tightness of Player > 1:
					...
					now sortorder entry is 9;
					now description entry is "attempt to shrink your[if Cock Count of Player > 1][cunt size desc of Player] cunts[else][cunt size desc of Player] cunt[end if] down a little";
